...
| `docs/` | English only. The user-facing surface (README, GUI, help, error advice) is bilingual; these are not, because two copies of measured claims drift and the drifted one lies |
...
* Translating `docs/` — see the table above.
