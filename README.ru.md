...
и объясняется, подробности в [docs/FINDINGS.md](docs/FINDINGS.md) §1. Остаётся **резидентный** загрузчик в бут-секторе — проприетарный, и в его таблице
...
единственным экземпляром, это хуже, чем отсутствие пути. См. [docs/FINDINGS.md](docs/FINDINGS.md) §1.
...
* ЭБУ M74 CAN с **впаянным трансивером L9637D**. На блоке, на котором всё это делалось,
  ...
  [docs/HARDWARE.md](docs/HARDWARE.md): доработка, какой номинал подтяжки решает, распиновка.
...
[docs/HARDWARE.md](docs/HARDWARE.md) описывает только M74 CAN. И успешное рукопожатие не
...
* **Один экземпляр ЭБУ.** Всё разработано и проверено на одном блоке. Другие ревизии плат
  ...
  [docs/HARDWARE.md](docs/HARDWARE.md), и сообщите о результате.
...
* [docs/HARDWARE.md](docs/HARDWARE.md) — доработка блока, распиновка, сборка стенда
* [docs/PROTOCOL.md](docs/PROTOCOL.md) — вход в загрузчик, стейджи, команды монитора и флеша
* [docs/QUIRKS.md](docs/QUIRKS.md) — всё, что K-line делает вопреки даташитам
* [docs/FINDINGS.md](docs/FINDINGS.md) — модель ошибок, тупики и ошибки измерений
* [docs/DEVELOPING.md](docs/DEVELOPING.md) — JSON-интерфейс, сборка, прогон проверок
